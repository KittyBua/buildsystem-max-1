...
ifeq ($(IMAGE_LAYOUT),subdirboot)
	...
	$(call draw_line);
	@echo -e "USER_IMAGE_DEPENDS              : $(TERM_GREEN)$(USER_IMAGE_DEPENDS)$(TERM_NORMAL)"
	@echo -e "USER_LIBSTB_HAL_CONF_OPTS       : $(TERM_GREEN)$(USER_LIBSTB_HAL_CONF_OPTS)$(TERM_NORMAL)"
	@echo -e "USER_NEUTRINO_PLUGINS_CONF_OPTS : $(TERM_GREEN)$(USER_NEUTRINO_PLUGINS_CONF_OPTS)$(TERM_NORMAL)"
	@echo -e "USER_NEUTRINO_CONF_OPTS         : $(TERM_GREEN)$(USER_NEUTRINO_CONF_OPTS)$(TERM_NORMAL)"
	@echo -e "USER_NEUTRINO_CFLAGS            : $(TERM_GREEN)$(USER_NEUTRINO_CFLAGS)$(TERM_NORMAL)"
	$(call draw_line);
	@echo ""
